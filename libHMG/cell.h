...
*
* Object containing the information for the plasmids. Although for ColE1, the replication time is 3s when the doubling time of a cell is 60min (i.e. 40min for a chromosome to duplicate)
* 
*
*/
typedef struct PLASMID
{
    ...
    //float geneCount[]; /**< Count the number of genes that are exposed based on their location*/
    ...
    //int repForks; //This should be implemented 
    //int potentialOriC; //
} Plasmid;
